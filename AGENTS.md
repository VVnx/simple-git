...
写给在本仓库工作的 Codex / agent 看的协作约定与项目速查。
...
- 每条 commit 结尾加一行:`Co-Authored-By: Codex Opus 4.8 <noreply@anthropic.com>`
...
- `Git/`
  ...
  - `GitService.swift` — 高层命令:log / status / refs / diff / fetch / pull / push / merge
